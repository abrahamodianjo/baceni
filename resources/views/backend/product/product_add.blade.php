            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add A New Product To Your List</li>
                    </ol>
                </nav>
            </div>
...
<div class="card">
  ...
  <div class="mb-3">
				<label for="inputProductTitle" class="form-label">Add Multiple Image</label>
			...
			<div class="border border-3 p-4 rounded">
              <div class="row g-3">
				<div class="form-group col-md-6">
				  ...
				  <div class=" form-group col-md-6">
					<label for="inputStarPoints" class="form-label">Product Quality</label>
					<input type="text" name="product_qty" class="form-control" id="inputStarPoints" placeholder="00.00">
				  </div>
				  <div class="col-12">
					<label for=" form-group inputProductType" class="form-label">Product Brand</label>
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
				...
				multi_img: {
                    required : 'Please Select Multiple pictures',
                },
				selling_price: {
				...
				brand_id: {
                    required : 'Please Select Brand Id',
                },
				category_id: {
