                    ...
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                        ...
                        <div class="logo mb-30">
                            <a href="index.html" class="mb-15"><img src="{{ asset($setting->logo) }}"
                                    alt="logo" /></a>
                            <p class="font-lg text-heading">Our goal is to provide you with all you need in Nigeria</p>
                        </div>
    ...
    <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-7 col-md-6">
                <p class="font-sm mb-0">{{ $setting->copyright }}<strong class="text-brand"> &copy; 2024</strong> 
                    </p>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 text-end d-none d-md-block">
                <div class="mobile-social-icon">
                    <h6>Follow Us </h6>
                    <a href="http://www.facebook.com/{{ $setting->facebook }}"><img
                            src="{{ asset('frontend/assets/imgs/theme/icons/icon-facebook-white.svg') }}"
                            alt="" /></a>
                    <a href="http://www.instagram.com/{{ $setting->twitter }}"><img
                            src="{{ asset('frontend/assets/imgs/theme/icons/icon-instagram-white.svg') }}"
                            alt="" /></a>                   
                    <a href="http://www.twitter.com/{{ $setting->youtube }}"><img
