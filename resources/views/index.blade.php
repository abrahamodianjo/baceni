...
<div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
    <div class="card">
        <div class="card-header">
            <h3 class="mb-0">Hello {{ Auth::user()->name }}</h3><br><br>
            ...
            <div class="card">
                ...
                <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" type="password" name="new_password_confirmation" class="form-control"  
